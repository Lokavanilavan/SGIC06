...
public class EmployeeController {
	...
	public ResponseEntity<Object> updateDetails(@PathVariable(value = "id")Long employeeId, @RequestBody Employee emp){
		
		return ResponseEntity.ok().body(employeeService.updateEmployee(employeeId, emp));
	}
